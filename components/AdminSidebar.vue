...
<template>
  ...
  >
    <div v-if="open" class="lg:hidden fixed inset-0 z-50 bg-forest-900/60" @click="open = false"></div>
  </transition>
  ...
  >
    <aside v-if="open" class="admin-drawer-panel lg:hidden fixed inset-y-0 left-0 z-50 h-full w-72 max-w-[85vw] bg-forest-800 text-white flex flex-col overflow-y-auto pt-safe-top shadow-floating">
