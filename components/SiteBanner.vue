    ...
    >
      ...
      <div class="relative flex items-center gap-5 p-5 sm:p-6 pr-14 sm:pr-6">
        ...
        <span
          ...
          class="hidden sm:flex shrink-0 items-center gap-1.5 rounded-full bg-white text-forest-800 px-4 py-2.5 text-sm font-semibold group-hover:bg-ivoire-100 transition-colors"
        >
